    ...
    return (
        <div className='w-[280px]'>
            ...
            <input type="search" value={inputValue} onChange={handleInputChange}
             name="" id="" placeholder="Search" className='!h-[37px] placeholder:text-[#8B8E98] w-full px-5 pl-[40px] focus-visible:outline-none bg-white rounded-[3px] py-2  text-[#3B3F88] '/>
