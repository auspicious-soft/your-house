...
const InputField: FC<InputFieldProps> = ({ type, value, placeholder, onChange , required, label, name }) => {
  return (
    <div className='mb-[30px]'>
      ...
      <input
      className='text-[#3B3F88] text-[12px] h-[50px] md:h-[50px] w-full focus-visible:outline-[#1657FF] focus-visible:outline focus-visible:outline-1  px-4 md:px-5 md:text-[14px] rounded-[50px] border-none bg-[#F4F5F7]'
      type={type}
      value={value}
      name={name}
